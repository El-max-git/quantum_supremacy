...
**Важно:** Метаданные загружаются автоматически из frontmatter статьи!
...
✅ **Список из метаданных** - читается из frontmatter файлов  
...
# 3. Автоматически обновить config.json
